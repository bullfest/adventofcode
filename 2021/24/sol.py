...
model.Maximize(cp_model.LinearExpr.ScalProd(inp_vars, list(reversed([10**i for i in range(14)]))))
...
model.Minimize(cp_model.LinearExpr.ScalProd(inp_vars, list(reversed([10**i for i in range(14)]))))
